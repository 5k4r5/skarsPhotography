// Create elements for the navigation menu and header
...
// Create list items for each menu link
...
let pathname = window.location.pathname;    // Get the current path name of the webpage
logo.src = pathname.includes('categories')? "../../images/webpage/elements/skars_logo_big.png" : "../images/webpage/elements/skars_logo_big.png";   // Set the source of the logo image based on the current path

// Set the href attribute for each navigation link based on the current path
...
// Set the inner text for each link
...
// Append each link to its corresponding list item
...
// Append the elements to eachother
...
// Add an event listener to toggle the menu and hamburger image when clicked
...
// Function to underline the link of the current page
